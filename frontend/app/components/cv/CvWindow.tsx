...
export default function ChatWindow({
  ...
  return (
    <div className="flex flex-col w-full h-screen bg-white">
      <div className="flex items-center justify-between h-[80px] shadow px-4 bg-[#E6FFFA] text-white">
        <div className="flex items-center gap-3">
          <ArrowLeft
            className="h-5 w-5 text-black cursor-pointer"
            onClick={onBack}
          />
          <div className="h-10 w-10 bg-[#00735A] text-white rounded-full flex items-center justify-center font-bold">
            JM
          </div>
          <div>
        ...
        <div className="flex items-center bg-white rounded-md shadow-md px-2 gap-1 py-1">
          <button onClick={() => setLanguage(language === "en" ? "am" : "en")}>
            <Globe className="h-5 w-5 text-[#00735A]" />
          </button>
      ...
      <div className="px-4 py-4 bg-[#E6FFFA] text-black justify-center">
        {<QuickActions />}
