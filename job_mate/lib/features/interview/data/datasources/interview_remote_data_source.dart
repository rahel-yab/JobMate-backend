...
abstract class InterviewRemoteDataSource {
  ...
  Future<InterviewMessageModel> sendFreeformMessage(String chatId, String message);
  ...
  Future<InterviewMessageModel> answerStructuredInterview(String chatId, String answer);
