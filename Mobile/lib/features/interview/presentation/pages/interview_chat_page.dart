...
class FreeformInterviewPage extends StatefulWidget {
  const FreeformInterviewPage({super.key});

  @override
  State<FreeformInterviewPage> createState() => _FreeformInterviewPageState();
}

class _FreeformInterviewPageState extends State<FreeformInterviewPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: ChatHeader(
        ...
        subtitle: 'Practice with AI Coach',
      ),
      body: Column(
        children: [
          Expanded(
          ...
          MessageInput(
            ...
            hintText: 'Ask a question or practice an answer...',
            onSend: () {
              final text = _controller.text.trim();
              if (text.isNotEmpty) {
                context.read<InterviewBloc>().add(SendFreeformMessage(text));
                _controller.clear();
              }
            },
          ),
            ...
            children: [
              ...
              Flexible(
                child: Container(
                  ...
                  child: const Text(
                    "Welcome to Freeform Interview Practice! "
                    "This is like having a conversation with an experienced interviewer. "
                    "Ask me any interview questions, practice your answers, or get tips on specific topics. "
                ...
                child: Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      const Text(
                        "What you can do:\n"
                        "• Ask me to give you interview questions\n"
                        "• Practice answering common questions\n"
                        "• Get feedback on your responses\n"
                        "• Learn interview tips and techniques\n"
